<x-layout>
    ...
    <div class="product" x-on:click="window.location.href='{{ route('product.show', ['slug' => 'basic-tee-black', 'city' => 'Surabaya']) }}'"  data-price="30" data-paket="family personal healthy advance event" data-karbo="variatif">
